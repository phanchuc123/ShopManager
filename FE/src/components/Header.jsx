        ...
        <header>
            ...
            <div className="header_item">
                <nav className="nav__pc">
                    <Link className = "item item1" to = "/">Trang chủ</Link>
                    <Link className = "item item2" to = "/shop">Cửa hàng</Link>
                    <Link className = "item item3" to = "/about">Giới thiệu</Link>
                    <Link className = "item item4" to = "/contact">Liên hệ</Link>
                </nav>
            </div>
                ...
                {user ? (
                    <div className="user-dropdown-container">
                        ...
                        <div className="user-dropdown-menu">
                            ...
                            {user.role === "admin" && (
                                <Link to="/admin" className="dropdown-item">Trang quản trị</Link>
                            )}
                            <button onClick={handleLogout} className="dropdown-item btn-logout">Đăng xuất</button>
                        </div>
                    </div>
                ) : (
                    <Link to="/login">
            ...
            <label htmlFor="nav__mobile-input" className="nav_bars-btn">
            ...
            <input type="checkbox" name="" id="nav__mobile-input" hidden />

            <label htmlFor="nav__mobile-input" className="nav_overlay"></label>
            <nav className="nav__mobile">
                <Link className = "item item1" to = "/">Trang chủ</Link>
                <Link className = "item item2" to = "/shop">Cửa hàng</Link>
                <Link className = "item item3" to = "/about">Giới thiệu</Link>
                <Link className = "item item4" to = "/contact">Liên hệ</Link>
                <Link className = "item item5" to = "/cart">Giỏ hàng</Link>
                {user ? (
                    <>
                        {user.role === "admin" && (
                            <Link className = "item item-admin" to = "/admin">Trang quản trị</Link>
                        )}
                        <Link className = "item item6" to = "/profile">Tài khoản ({user.username})</Link>
                        <span className = "item item7" onClick={handleLogout} style={{cursor: 'pointer'}}>Đăng xuất</span>
                    </>
                ) : (
                    <Link className = "item item6" to = "/login">Đăng nhập</Link>
                )}
            </nav>
        </header>
